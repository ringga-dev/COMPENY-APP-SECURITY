                            ...
                            <tbody>
                                ...
                                foreach ($visitor as $u) :
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"> <?= $u['privilege_name']; ?></td>
                                        ...
                                        <td class="text-center">
                                            ...
                                            ?>
                                                <a href="<?= base_url() ?>/admin/delete_devisi/<?= $u['id']; ?>" class="badge badge-danger m-1 hapus"><i class="fas fa-trash-alt fa-2x"></i></a>
                                            <?php endif; ?>
                                        </td>
                                    </tr>
                                    <!-- modal barang edit -->
                                    <div class="modal fade" id="modal-xl<?= $u['id'] ?>">
                                        <div class="modal-dialog modal-xl">
                                            <div class="modal-content">
                                                ...
                                                <form action="<?= base_url() ?>/admin/edit_devisi/<?= $u['id'] ?>" method="POST" enctype="multipart/form-data">
                                                    <?= csrf_field() ?>
                                                            ...
                                                            <div class="col-md-12">
                                                                <div class="card-body">
                                                                    <div class="form-group">
                                                                        <label for="shift">Devisi</label>
                                                                        <div class="input-group">
                                                                            <input type="text" class="form-control" id="privilege_name" name="privilege_name" value="<?= $u['privilege_name']; ?>" required>
                                                                        </div>
                                                                    </div>
...
<div class="modal fade" id="modal-xl">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <!-- class="was-validated" -->
            <form action="<?= base_url() ?>/admin/add_devisi" method="POST" enctype="multipart/form-data">
                <?= csrf_field() ?>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card-body">
                                <div class="form-group">
                                    <label for="shift">Devisi</label>
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="privilege_name" name="privilege_name" required>
                                    </div>
                                </div>
